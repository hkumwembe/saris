...
$loader->add('Entity',__DIR__.'/module/Application/src/Application/Entity');
...
$annotationDriver = new Doctrine\ORM\Mapping\Driver\AnnotationDriver(
    $cachedAnnotationReader, // our cached annotation reader
    array('module/Application/src/Application/Entity') // paths to look in
);
...
$loggableListener->setUsername('hkumwembe');

...
class FsServicedmodule extends Fieldset implements InputFilterProviderInterface
{
    protected $em;
    protected $deptid;
    ...
    public function getStaff(){
        $options = array("UNABLETOALLOCATE"=>"(Unable to allocate)");
        if($this->deptid != NULL){
    ...
    public function __construct(\Doctrine\ORM\EntityManager $em = null,$deptid = null)
    {
        ...
        parent::__construct('Servicedmodule');
